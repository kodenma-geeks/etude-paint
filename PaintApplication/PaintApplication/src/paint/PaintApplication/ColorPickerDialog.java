...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        // ”wŒiF‚ªˆÃ‚¢Žž‚Í”’•¶Žš‚É‚·‚éƒƒ\ƒbƒh
        public int negaPosi(int color){
        	int c;
        	if(Color.red(color) < 33 && Color.green(color) < 33 && Color.blue(color) < 33){
        		c = Color.WHITE;
        	}
        	else{
        		c = Color.BLACK;
...
//            Paint textPaint = new Paint();
            textPaint.setColor(negaPosi(mInitialColor));
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if (mTrackingOK) {
                        ...
                        mOKPaint.setColor(selectColor);
                        textPaint.setColor(negaPosi(selectColor));
